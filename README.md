# ⚖️ Synthesis Reranking Service

> Hybrid reranking aggregator blending Cohere API and local BGE model scores for optimal MRR@10.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/synthesis-reranking-service/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-synthesis-reranking-service.git
cd tp-synthesis-reranking-service
```
...
```bash
kubectl port-forward deployment/tp-synthesis-reranking-service 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
```text
tp-synthesis-reranking-service/
...
└── primary_config/
    └── hybrid_reranker.py     # Main configuration file
```
...
---
*Generated by [Synthesis Reranking Service Studio](https://pradeeptalari14.github.io/portfolio/tools/synthesis-reranking-service/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
